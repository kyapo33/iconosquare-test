      ...
      <div className='mx-auto max-w-7xl px-8'>
        <div className='mx-auto max-w-2xl lg:mx-0'>
          ...
          <div className='text-gray-600 text-lg leading-8'>
            <p className='my-6 '>
              The following graph is a simulation of a live stream of events that refreshes every 2s. The events are
              stored in a context. We want to be able to edit some events.
            </p>
